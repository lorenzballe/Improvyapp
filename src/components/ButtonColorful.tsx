    ...
    <button
      className={cn(
        isWhite 
          ...
          : "relative h-11 px-6 overflow-hidden rounded-xl flex items-center justify-center font-bold tracking-wider uppercase font-sans text-xs active:scale-95 cursor-pointer border border-white/5 bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900 transition-all duration-200 group",
        className
      )}
      {...props}
    >
        ...
        <span 
          className={cn(
            isWhite 
              ...
              : "text-white dark:text-zinc-900 font-sans tracking-widest"
          )}
        >
          {label}
        </span>
        <ArrowUpRight 
          className={cn(
            isWhite 
              ...
              : "w-3.5 h-3.5 text-white/90 dark:text-zinc-900/90 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-200"
          )} 
        />
      </div>
    </button>
